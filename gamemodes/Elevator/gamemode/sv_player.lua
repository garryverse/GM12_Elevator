...
function GM:PlayerInitialSpawn( ply )
	timer.Simple( 1, self.SendNPCNames, self, ply )
end
...
function GM:PlayerSetModel( pl )
	...
	if string.find( modelname, "Kleiner" ) || string.find( modelname, "super" ) then -- too white for the elevator :(
		modelname = player_manager.TranslatePlayerModel( "barney" )
	end
