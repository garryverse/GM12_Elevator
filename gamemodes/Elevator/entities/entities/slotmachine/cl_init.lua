...
function ENT:DrawDisplay()
	...
	cam.Start3D2D( pos, ang, scale )	
		...
		draw.SimpleText( "Jackpot: " .. self:GetJackpot(), "ScoreboardText", 10, 7, Color(255,255,255,255), TEXT_ALIGN_LEFT, TEXT_ALIGN_TOP )
		draw.SimpleText( "Bet Amount: " .. Casino.SlotsLocalBet, "ScoreboardText", 10, 80, Color(255,255,255,255), TEXT_ALIGN_LEFT, TEXT_ALIGN_TOP )
...
surface.CreateFont ("coolvetica", 22, 200, true, false, "Buttons" )
...
function ENT:MouseRayInteresct( pos, ang )
	...
	return RayQuadIntersect( EyePos(), LocalPlayer():GetCursorAimVector(), plane, x, y )
end
